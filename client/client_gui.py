...
from client.rtp_client import RTPClient
...
class ClientWindow(QMainWindow):
    ...
    def __init__(
        ...
        self._media_client = RTPClient(file_name, host_address, host_port, rtp_port)
    ...
    def init_ui(self):
        self.setWindowTitle("RTP Client by Cong Nguyen")
